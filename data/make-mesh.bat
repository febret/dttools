...
SET dtmerge=D:/Workspace/ENDURANCE/dttools/trunk/bin/win-x86-vs10-release/dtmerge.exe 
SET meshlab="C:\Program Files\VCG\MeshLab\meshlabserver.exe"
SET dtpoisson=D:/Workspace/ENDURANCE/dttools/trunk/bin/win-x86-vs10-debug/dtpoisson.exe 
...
REM cd bonney
REM copy bonney-points.csv %postfix%\bonney-all-points-%postfix%.asc
REM cd ..
